...
d3.densityPlotNoLines = function(){
    ...
    area1 = d3.svg.line()
        .x(function(d) {
            if (scaleX(d.x1) > scaleX(domainXMax)){return scaleX(domainXMax);}
            else if(scaleX(d.x1) < scaleX(domainXMin)){return scaleX(domainXMin);}
    ...
    area0 = d3.svg.line()
        .x(function(d) {
            if (scaleX(d.x0) > scaleX(domainXMax)){return scaleX(domainXMax);}
            else if(d.x0 < scaleX(domainXMin)){return scaleX(domainXMin);}
